    ...
    async cancel() {
        ...
        await this.setState({
            userPackage: {
                ...
                heroname: this.props.user.heroname,
        ...
        return (
            <div key={'user-' + user.userid} className="card">
                ...
                {!this.state.update && <ul className="list-group list-group-flush">
                    ...
                    {this.props.user.role === 'Admin' && <select className="form-control" value={this.state.roleSelection} onChange={this.changeSelection}>
